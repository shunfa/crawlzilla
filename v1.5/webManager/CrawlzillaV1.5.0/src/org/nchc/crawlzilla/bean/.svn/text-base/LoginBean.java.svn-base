...
public class LoginBean {
	public boolean getConfirm(String user, String passwd) throws IOException,
			NoSuchAlgorithmException {
		File UserExists = new File("/home/crawler/crawlzilla/user/" + user
				+ "/meta/passwd");
		if (UserExists.exists()) {
			System.out.println("user exists!");

			FileReader NP = new FileReader("/home/crawler/crawlzilla/user/"
					+ user + "/meta/passwd");
	...
	public boolean checkFristLogin() throws IOException {
		File checkExists = new File(
				"/home/crawler/crawlzilla/user/admin/meta/passwd");
		if (checkExists.exists()) {
			FileReader NP = new FileReader(
					"/home/crawler/crawlzilla/user/admin/meta/passwd");
			BufferedReader stdin = new BufferedReader(NP);
			String crawlerPasswd = new String(stdin.readLine());
	...
	public void changePW(String userName, String newPW) throws IOException {
	...
	public void setEmail(String userName, String newEmail) throws IOException {
		...
		File email_file = new File("/home/crawler/crawlzilla/user/" + userName
				+ "/meta/email");

		FileWriter fout = new FileWriter(email_file);
		BufferedWriter foutWriter = new BufferedWriter(fout);
	...
	public String getEmail(String userName) throws IOException {
		...
		if (email_file.exists()) {
			BufferedReader p_in = new BufferedReader(new FileReader(email_file));
			ret = p_in.readLine();
			p_in.close();
		}
		return ret;
	...
	public void setLang(String userName, String lang) throws IOException {
		String language = "en";
		...
		File lang_file = new File("/home/crawler/crawlzilla/user/" + userName
				+ "/meta/weblang");
		// Thread.sleep(10);
		BufferedWriter foutWriter = new BufferedWriter(
				new FileWriter(lang_file));
		foutWriter.write(language);
		foutWriter.close();
	}
