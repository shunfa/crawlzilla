...
<%
	...
	if (titles.endsWith("jsp"))
		titles = titles.substring(titles.lastIndexOf("/") + 1,
				titles.lastIndexOf(".jsp"));
	else
		titles = "index";
	//out.println(titles);
%>
		...
		<div id="tabs" class="noprint">
			...
			<ul class="box">
				...
				<div id="tabs">
					<ul>
						<!-- 完成實做id="active" -->
						<li <%if (titles.equals("index"))
				out.print("id=active");%>><a
							href="index.jsp">Home</a>
						</li>
						<li <%if (titles.equals("crawl"))
				out.print("id=active");%>><a
							href="crawl.jsp">Crawl</a>
						</li>
						<li <%if (titles.equals("indexpool"))
				out.print("id=active");%>><a
							href="indexpool.jsp"><i18n:message
									key="header_indexpoolManage" />
						</a>
						</li>
						<li <%if (titles.equals("order"))
				out.print("id=active");%>><a
							href="order.jsp"><i18n:message key="header_systemOrder" />
						</a>
						</li>
						<li <%if (titles.equals("slave"))
				out.print("id=active");%>><a
							href="slave.jsp"><i18n:message key="header_slaveInstall" />
						</a>
						</li>
						<li <%if (titles.equals("setup"))
				out.print("id=active");%>><a
							href="setup.jsp"><i18n:message key="header_setup" />
						</a>
						</li>
						<%
							if (session.getAttribute("loginFlag") == "true") {
						...
						%>
						<li <%if (titles.equals("login"))
					out.print("id=active");%>><a
							href="login.jsp"><i18n:message key="header_login" />
						</a>
						</li>
					</ul>
