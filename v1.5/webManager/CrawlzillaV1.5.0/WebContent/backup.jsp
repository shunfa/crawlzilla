...
<title><i18n:message key="crawl_setup" />使用者資料備份/還原</title>
<body id="www-url-cz">
<script>
	$(function() {
	...
	<div id=home>
		<div class="article">
            ...
            <div id="accordion">
         	<h3><a href="#">備份</a></h3>
            <div>
                <form id="form1" method="post" action=Backup.do">
...
<h3><a href="#"><i18n:message key="crawl_orderSetup" />還原</a></h3>
<div>
