...
<jsp:useBean id="iDBDetail" class="org.nchc.crawlzilla.bean.IDBDetailBean" scope="session" /> 
<script>
	$(function() {
		$( "#accordion" ).accordion({
				autoHeight: false,
          		...
          		<div class="demo">
            		...
            		<div id="accordion">                     
              			...
              			<div>
              				...
              				<p> <img src="http://<% out.print(masterIPAddress); %>/default/img/reiter/logo_nutch.gif" alt="Crawlzilla logo with orange color, CrawlzillaReleased"><form name="search" action="http://<% out.print(masterIPAddress + "/" + UserName + "_" + IDBName); %>/search.jsp" method="get"><input name="query" size=15></form></p>
              				<p class="info noprint"></p>
              				<h3><p class="info noprint"><i18n:message key="IDBDetial_syntax" /></p></h3>
              				<p> &lt;img src="http://<% out.print(masterIPAddress); %>/default/img/reiter/logo_nutch.gif" &gt;</p>
              				<p> &lt;form name="search" action="http://<% out.print(masterIPAddress); %>/<% out.print(UserName + "_" + IDBName ); %>/search.jsp" method="get"&gt;</p>
...
<div id="col" class="noprint">
	<div id="col-in">
		...
		<ul id="category">
			<li><a target="_new" href=<%out.print("http://" + masterIPAddress + ":10030");%>><i18n:message key="IDBDetial_jobtrackerStatus" /></a></li>
			<li><a target="_new" href=<%out.print("http://" + masterIPAddress + ":10070");%>><i18n:message key="IDBDetial_namenodeStatus" /></a></li>
		</ul>
		<hr class="noscreen" />
		<hr class="noscreen" />
        </div> <!-- /col-in -->
