...
<div id="col" class="noprint">
	<div id="col-in">
		...
		try{
			for(int j=0; j < IDBNum; j++){
				out.print("<li><a href=http://" + masterIPAddress + "/" + userName + "_" + IDBfoldersName[j].getName()+ ">" + IDBfoldersName[j].getName() + "</a></li>");
			}
		}
		catch(NullPointerException e){
		...
		<ul id="category">
		<li><a target="_new" href=<%out.print("http://" + masterIPAddress + ":10030");%>><i18n:message key="order_jobtrackerStatus" /></a>              </li>
		<li><a target="_new" href=<%out.print("http://" + masterIPAddress + ":10070");%>><i18n:message key="order_namenodeStatus" /></a>              </li>
		</ul>
		<hr class="noscreen" />
		<hr class="noscreen" />
            </div> <!-- /col-in -->
